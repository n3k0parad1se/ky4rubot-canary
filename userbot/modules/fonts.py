...
async def weebify(event):
    ...
    if not args:
        ...
        args = get.text
    if not args:
        await event.edit("**O que eu deveria transformar em otakice?**")
        return
...
async def circly(event):
    ...
    if not args:
        ...
        args = get.text
    if not args:
        await event.edit("**O que eu deveria deixar circular?**")
        return
    string = "  ".join(args).lower()
    for normiecharacter in string:
        if normiecharacter in normiefont:
...
async def oldy(event):
    ...
    if not args:
        ...
        args = get.text
    if not args:
        await event.edit("**Eu funciono com textos apenas.**")
        return
    string = "  ".join(args).lower()
    for normiecharacter in string:
        if normiecharacter in normiefont:
